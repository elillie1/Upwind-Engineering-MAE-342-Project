...
[**1. Overview of Phase 3	3**](#1.-overview-of-phase-3)
...
## 1.1 Phase 3 Objectives {#1.1-phase-3-objectives}
...
## 1.2 Scope of Phase 3 {#1.2-scope-of-phase-3}
...
# 2\. Prototype Fabrication {#2.-prototype-fabrication}

## 2.1 Fabrication Overview {#2.1-fabrication-overview}
...
## 2.2 Additive Manufacturing Details {#2.2-additive-manufacturing-details}
...
### 2.2.1 Printer Details {#2.2.1-printer-details}

#### 2.2.1.1 Printer Model {#2.2.1.1-printer-model}

* Creality K2 Combo

#### 2.2.1.2 Filament Type {#2.2.1.2-filament-type}

* Creality Ender PLA

#### 2.2.1.3 Nozzle Size {#2.2.1.3-nozzle-size}

* 0.4 mm

#### 2.2.1.4 Layer Height {#2.2.1.4-layer-height}

* 0.2 mm

#### 2.2.1.5 Infill Percentage {#2.2.1.5-infill-percentage}

* 15%

#### 2.2.1.6 Print Speed {#2.2.1.6-print-speed}

* 250 mm/s

#### 2.2.1.7 Printer Support Settings {#2.2.1.7-printer-support-settings}

* Tree Supports with top Z distance 0.2mm

#### 2.2.1.8 Print Orientation Notes {#2.2.1.8-print-orientation-notes}
...
#### 2.2.2.1 Hub Top and Bottom {#2.2.2.1-hub-top-and-bottom}

**Figure 2: Physical Model for Hub Top**  
**Figure 3: Physical Model for Hub Bottom**  
2.2.2.2 Blade Carriers {#2.2.2.2-blade-carriers}

**Figure 4: Physical Model for Blade Carriers (x3)**  
2.2.2.3 Blade Linkages {#2.2.2.3-blade-linkages}

**Figure 5: Physical Model for the Blade Linkages (x3) (Side-View)**  
**Figure 6: Physical Model for the Blade Linkages (x3) (Top-View)**  
2.2.2.5 Linear Disc {#2.2.2.5-linear-disc}
...
**Figure 8: Physical Model for the 10-tooth Linear Gears**  
**Figure 9: Physical Model for the 16-tooth Linear Gears**  
2.2.2.9 Thrust Bearing Components {#2.2.2.9-thrust-bearing-components}
...
**Figure 14: Physical Model for the Thrust Bearing Bottom Back (1)**  
**Figure 15: Physical Model for the Thrust Bearing Bottom Back (2)**  
2.2.2.10 Wind Turbine Blades {#2.2.2.10-wind-turbine-blades}

**Figure 16: Physical Model for the Turbine Blades**  
2.2..11 Final Prototype Assembly {#2.2..11-final-prototype-assembly}
...
## 2.3 Print Iterations and Reprints {#2.3-print-iterations-and-reprints}
...
## 2.4 Other Manufacturing Materials Used {#2.4-other-manufacturing-materials-used}
...
# 3\. Assembly Procedure and Challenges {#3.-assembly-procedure-and-challenges}

## 3.1 Assembly Procedure {#3.1-assembly-procedure}

### 3.1.1 Thrust Bearing Assembly {#3.1.1-thrust-bearing-assembly}
...
### 3.1.2 Hub Assembly {#3.1.2-hub-assembly}
...
### 3.1.3 Final Integration {#3.1.3-final-integration}
...
### 3.1.4 Summarized List for Full Assembly {#3.1.4-summarized-list-for-full-assembly}
...
## 3.2 Assembly Challenges {#3.2-assembly-challenges}
...
# 4\. Prototype Testing and Results {#4.-prototype-testing-and-results}

## 4.1 Test Objectives {#4.1-test-objectives}
...
## 4.2 Test Procedure {#4.2-test-procedure}
...
## 4.3 Test Results {#4.3-test-results}
...
## 4.4 Interpretation of Results {#4.4-interpretation-of-results}
...
# 5\. Comparison to Phase 2 Projections and Predictions {#5.-comparison-to-phase-2-projections-and-predictions}
...
# 6\. Failures, Mistakes, and Lessons Learned {#6.-failures,-mistakes,-and-lessons-learned}

## 6.1 Major Failures Observed {#6.1-major-failures-observed}
...
## 6.2 Mistakes in Fabrication and Assembly {#6.2-mistakes-in-fabrication-and-assembly}
...
## 6.3 Unexpected Outcomes {#6.3-unexpected-outcomes}
...
## 6.4 Lessons Learned {#6.4-lessons-learned}
...
# 7\. Recommended Design Changes For Final Product {#7.-recommended-design-changes-for-final-product}
